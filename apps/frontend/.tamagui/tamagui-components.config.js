...
var require_Adapt = __commonJS({
  "../../node_modules/@tamagui/adapt/dist/cjs/Adapt.js"(exports, module2) {
    ...
    var AdaptParentContext = (0, import_react12.createContext)(null);
    var AdaptContents = /* @__PURE__ */ __name((props) => {
      const context = (0, import_react12.useContext)(AdaptParentContext);
      if (!(context == null ? void 0 : context.Contents)) {
        throw new Error("Adapt not supported by this component");
      }
      return (0, import_react12.createElement)(context.Contents, props);
    }, "AdaptContents");
    AdaptContents["shouldForwardSpace"] = true;
    var useAdaptParent2 = /* @__PURE__ */ __name(({
      Contents
    }) => {
      const [when, setWhen] = (0, import_react12.useState)(null);
      const AdaptProvider = (0, import_react12.useMemo)(() => {
        const context = {
          Contents,
          setWhen
        };
...
var require_compose_refs = __commonJS({
  "../../node_modules/@tamagui/compose-refs/dist/cjs/compose-refs.js"(exports, module2) {
    ...
    var React15 = __toESM2(require("react"));
  ...
  "../../node_modules/@tamagui/create-context/dist/cjs/create-context.js"(exports, module2) {
    ...
    function createContextScope3(scopeName, createContextScopeDeps = []) {
      ...
      function createContext22(rootComponentName, defaultContext) {
        const BaseContext = React15.createContext(
          defaultContext
        );
...
var require_usePresence = __commonJS({
  "../../node_modules/@tamagui/use-presence/dist/cjs/usePresence.js"(exports, module2) {
    ...
    function usePresence() {
      const context = (0, import_react12.useContext)(import_PresenceContext.PresenceContext);
      if (!context) {
        return [true, null, context];
      }
      const { isPresent: isPresent2, onExitComplete, register } = context;
      const id = (0, import_react12.useId)() || "";
      (0, import_react12.useEffect)(() => register(id), [id, register]);
    ...
    function useIsPresent() {
      return isPresent((0, import_react12.useContext)(import_PresenceContext.PresenceContext));
    }
...
var require_PresenceChild = __commonJS({
  "../../node_modules/@tamagui/animate-presence/dist/cjs/PresenceChild.js"(exports, module2) {
    ...
    var PresenceChild = /* @__PURE__ */ __name(({
      ...
      const presenceChildren = React15.useMemo(newChildrenMap, []);
      const id = (0, import_react12.useId)() || "";
...
var require_AnimatePresence = __commonJS({
  "../../node_modules/@tamagui/animate-presence/dist/cjs/AnimatePresence.js"(exports, module2) {
    ...
    var import_jsx_runtime12 = require("react/jsx-runtime");
    var import_core29 = require("@tamagui/core-node");
    var import_react12 = __toESM2(require("react"));
    ...
    function onlyElements(children) {
      const filtered = [];
      import_react12.Children.forEach(children, (child, index3) => {
        if ((0, import_react12.isValidElement)(child)) {
          if (!child.key) {
            ...
            filtered.push(
              import_react12.default.cloneElement(child, {
                key: index3
              })
            );
          } else {
    ...
    var AnimatePresence2 = /* @__PURE__ */ __name(({
      ...
      const forceRenderLayoutGroup = (0, import_react12.useContext)(import_LayoutGroupContext.LayoutGroupContext).forceRender;
      ...
      const presentChildren = (0, import_react12.useRef)(childrenToRender);
      const allChildren = (0, import_react12.useRef)(/* @__PURE__ */ new Map()).current;
      ...
      const hasWarned = process.env.NODE_ENV === "development" ? (0, import_react12.useRef)(false) : null;
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, {
        children: exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react12.cloneElement)(child))
      });
    }, "AnimatePresence");
...
var require_useGet = __commonJS({
  "../../node_modules/@tamagui/use-event/dist/cjs/useGet.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect3 = !isWeb8 || isClient3 ? import_react12.useLayoutEffect : import_react12.useEffect;
    function useGet4(currentValue, initialValue, forwardToFunction) {
      const curRef = (0, import_react12.useRef)(initialValue ?? currentValue);
...
var require_Dismissable = __commonJS({
  "../../node_modules/@tamagui/dismissable/dist/cjs/Dismissable.js"(exports, module2) {
    ...
    var DismissableContext = React15.createContext({
      layers: /* @__PURE__ */ new Set(),
      layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
      branches: /* @__PURE__ */ new Set()
    });
    var Dismissable2 = React15.forwardRef(
      (props, forwardedRef) => {
        const {
        ...
        const context = React15.useContext(DismissableContext);
    ...
    var DismissableBranch = React15.forwardRef(
      (props, forwardedRef) => {
        const context = React15.useContext(DismissableContext);
...
var require_FocusScope = __commonJS({
  "../../node_modules/@tamagui/focus-scope/dist/cjs/FocusScope.js"(exports, module2) {
    ...
    var FocusScope2 = React15.forwardRef(
      (props, forwardedRef) => {
        const {
          loop = false,
          trapped = false,
...
var require_Portal = __commonJS({
  "../../node_modules/@tamagui/portal/dist/cjs/Portal.js"(exports, module2) {
    ...
    var Portal = /* @__PURE__ */ __name(({ host = ((_a) => (_a = globalThis.document) == null ? void 0 : _a.body)(), ...props }) => {
      ...
      const [hostElement, setHostElement] = React15.useState(null);
      (0, import_core29.useIsomorphicLayoutEffect)(() => {
        setHostElement(host);
      }, [host]);
      if (hostElement) {
...
var require_GorhomPortal = __commonJS({
  "../../node_modules/@tamagui/portal/dist/cjs/GorhomPortal.js"(exports, module2) {
    ...
    var usePortal = /* @__PURE__ */ __name((hostName = "root") => {
      ...
      const deregisterHost2 = (0, import_react12.useCallback)(() => {
        dispatch({
          type: 1,
          hostName
        });
      }, []);
      const addUpdatePortal2 = (0, import_react12.useCallback)((name, node) => {
        dispatch({
          type: 2,
          hostName,
          portalName: name,
      ...
      const removePortal2 = (0, import_react12.useCallback)((name) => {
        dispatch({
          type: 3,
          hostName,
          portalName: name
    ...
    var PortalProviderComponent = /* @__PURE__ */ __name(({
      ...
      const [state, dispatch] = (0, import_react12.useReducer)(reducer, INITIAL_STATE);
      const transitionDispatch = (0, import_react12.useMemo)(() => {
        const next = /* @__PURE__ */ __name((value) => {
          (0, import_react12.startTransition)(() => {
            dispatch(value);
          });
        }, "next");
        return next;
    ...
    var PortalProvider3 = (0, import_react12.memo)(PortalProviderComponent);
            ...
            if (forwardProps) {
              ...
              if (Array.isArray(next)) {
                if (Object.keys(rest).length) {
                  next = next.map(
                    (item2) => (0, import_react12.isValidElement)(item2) ? (0, import_react12.cloneElement)(item2, rest) : item2
                  );
                }
                if (space || separator) {
                  next = (0, import_core29.spacedChildren)({
                ...
                next = import_react12.default.isValidElement(next) ? import_react12.default.cloneElement(next, { key: next.key, ...forwardProps }) : next;
              }
            }
            return next;
          })
    ...
    var PortalHost2 = (0, import_react12.memo)(PortalHostComponent);
    ...
    var PortalItem2 = (0, import_react12.memo)(PortalComponent);
...
var require_hoc = __commonJS({
  "../../node_modules/use-sidecar/dist/es5/hoc.js"(exports) {
    ...
    var React15 = tslib_1.__importStar(require("react"));
    ...
    function sidecar(importer, errorComponent) {
      ...
      return /* @__PURE__ */ __name(function Sidecar(props) {
        ...
        return Car ? React15.createElement(Car, tslib_1.__assign({}, props)) : null;
      }, "Sidecar");
    }
  ...
  "../../node_modules/use-sidecar/dist/es5/renderProp.js"(exports) {
    ...
    function renderCar(WrappedComponent, defaults) {
      function State(_a) {
        ...
        return React15.createElement(WrappedComponent, tslib_1.__assign({}, props, { children: renderTarget }));
      }
      __name(State, "State");
      var Children2 = React15.memo(function(_a) {
      ...
      return /* @__PURE__ */ __name(function Combiner(props) {
        var defaultState = React15.useRef(defaults(props));
        var ref = React15.useRef(function(state) {
          return defaultState.current = state;
        });
        return React15.createElement(
          React15.Fragment,
          null,
          React15.createElement(State, { stateRef: ref, props }),
          React15.createElement(Children2, { stateRef: ref, defaultState, children: props.children })
        );
      }, "Combiner");
    }
...
var require_exports = __commonJS({
  "../../node_modules/use-sidecar/dist/es5/exports.js"(exports) {
    ...
    var SideCar = /* @__PURE__ */ __name(function(_a) {
      ...
      return React15.createElement(Target, tslib_1.__assign({}, rest));
    }, "SideCar");
...
var require_UI = __commonJS({
  "../../node_modules/react-remove-scroll/dist/es5/UI.js"(exports) {
    ...
    var RemoveScroll2 = React15.forwardRef(function(props, parentRef) {
      ...
      return React15.createElement(
        React15.Fragment,
        null,
        enabled && React15.createElement(SideCar, { sideCar: medium_1.effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref }),
        forwardProps ? React15.cloneElement(React15.Children.only(children), tslib_1.__assign(tslib_1.__assign({}, containerProps), { ref: containerRef })) : React15.createElement(Container, tslib_1.__assign({}, containerProps, { className, ref: containerRef }), children)
      );
    });
...
var require_SideEffect = __commonJS({
  "../../node_modules/react-remove-scroll/dist/es5/SideEffect.js"(exports) {
    ...
    function RemoveScrollSideCar(props) {
      ...
      var Style = React15.useState(function() {
      ...
      return React15.createElement(
        ...
        removeScrollBar ? React15.createElement(react_remove_scroll_bar_1.RemoveScrollBar, { gapMode: "margin" }) : null
      );
    }
...
var require_Combination = __commonJS({
  "../../node_modules/react-remove-scroll/dist/es5/Combination.js"(exports) {
    ...
    var ReactRemoveScroll = React15.forwardRef(function(props, ref) {
      return React15.createElement(UI_1.RemoveScroll, tslib_1.__assign({}, props, { ref, sideCar: sidecar_1.default }));
    });
...
var require_cjs15 = __commonJS({
  "../../node_modules/@tamagui/use-constant/dist/cjs/index.js"(exports, module2) {
    ...
    function useConstant(fn) {
      if (typeof document === "undefined") {
        return (0, import_react12.useMemo)(() => fn(), []);
      }
...
var require_useControllableState = __commonJS({
  "../../node_modules/@tamagui/use-controllable-state/dist/cjs/useControllableState.js"(exports, module2) {
    ...
    function useControllableState2({
      ...
      const transitionFn = transition ? import_react12.startTransition : emptyCallbackFn2;
      (0, import_react12.useEffect)(() => {
        if (prop === void 0)
          return;
  ...
  "../../node_modules/@tamagui/sheet/dist/cjs/SheetScrollView.js"(exports, module2) {
    ...
    var SheetScrollView = (0, import_react12.forwardRef)(
      ({ __scopeSheet, children, ...props }, ref) => {
        ...
        const [scrollEnabled, setScrollEnabled_] = (0, import_react12.useState)(true);
...
var require_Sheet = __commonJS({
  "../../node_modules/@tamagui/sheet/dist/cjs/Sheet.js"(exports, module2) {
    ...
    var ParentSheetContext = (0, import_react12.createContext)({
      zIndex: 40
    });
    ...
    var Sheet = (0, import_core29.withStaticProperties)(
      (0, import_react12.forwardRef)(/* @__PURE__ */ __name(function Sheet2(props, ref) {
    ...
    var SheetImplementation = (0, import_core29.themeable)(
      (0, import_react12.forwardRef)(/* @__PURE__ */ __name(function SheetImplementation2(props, ref) {
        const parentSheet = (0, import_react12.useContext)(ParentSheetContext);
        ...
        const at = (0, import_react12.useRef)(0);
        driver.useAnimatedNumberReaction(animatedNumber, (value) => {
          at.current = value;
          scrollBridge.paneY = value;
        });
        const [isResizing, setIsResizing] = (0, import_react12.useState)(true);
        (0, import_core29.useIsomorphicLayoutEffect)(() => {
          if (!isResizing) {
            setIsResizing(true);
          }
        ...
        const positions = (0, import_react12.useMemo)(
          () => snapPoints.map((point) => getPercentSize(point, frameSize)),
          [frameSize, snapPoints]
        );
        const [opacity, setOpacity] = (0, import_react12.useState)(open ? 1 : 0);
        if (open && opacity === 0) {
          setOpacity(1);
        }
        (0, import_react12.useEffect)(() => {
        ...
        const [isShowingInnerSheet, setIsShowingInnerSheet] = (0, import_react12.useState)(false);
        const shouldHideParentSheet = !import_core29.isWeb && modal && isShowingInnerSheet;
        const parentSheetContext = (0, import_react12.useContext)(SheetInsideSheetContext);
        const onInnerSheet = (0, import_react12.useCallback)((hasChild) => {
          setIsShowingInnerSheet(hasChild);
        }, []);
        const panResponder = (0, import_react12.useMemo)(
          () => {
            if (disableDrag)
              return;
            if (!frameSize)
        ...
        import_react12.default.Children.forEach(childrenProp, (child) => {
          var _a, _b;
          if ((0, import_react12.isValidElement)(child)) {
        ...
        const nextParentContext = (0, import_react12.useMemo)(
          () => ({
            zIndex
          }),
          [zIndex]
        );
        const handleLayout = (0, import_react12.useCallback)((e) => {
          var _a;
        ...
        const adaptContext = (0, import_react12.useContext)(import_adapt2.AdaptParentContext);
        if (modal) {
    ...
    var SheetInsideSheetContext = (0, import_react12.createContext)(null);
    ...
    var SheetControllerContext = (0, import_react12.createContext)(null);
    var SheetController2 = /* @__PURE__ */ __name(({
      ...
      const memoValue = (0, import_react12.useMemo)(
        () => ({
          open: value.open,
          hidden: value.hidden,
...
var require_wrapChildrenInText = __commonJS({
  "../../node_modules/@tamagui/text/dist/cjs/wrapChildrenInText.js"(exports, module2) {
    ...
    function wrapChildrenInText2(TextComponent, propsIn) {
      ...
      const allChildren = import_react12.default.Children.toArray(children);
      const nextChildren = [];
      ...
      function concatStringChildren() {
        ...
        nextChildren[index3] = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(TextComponent, {
          ...props,
          ...textProps,
...
var require_Dialog = __commonJS({
  "../../node_modules/@tamagui/dialog/dist/cjs/Dialog.js"(exports, module2) {
    ...
    var DialogTrigger2 = React15.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogOverlay2 = React15.forwardRef(
    ...
    var DialogOverlayImpl2 = React15.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogContentModal2 = React15.forwardRef(
    ...
    var DialogContentNonModal2 = React15.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogContentImpl2 = React15.forwardRef(
      (props, forwardedRef) => {
        const {
          __scopeDialog,
          trapFocus,
    ...
    var DialogTitle2 = React15.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogDescription2 = React15.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogClose2 = React15.forwardRef(
      (props, forwardedRef) => {
...
For more information, see https://radix-ui.com/primitives/docs/components/${titleWarningContext.docsSlug}`;
    ...
    var Dialog3 = (0, import_core29.withStaticProperties)(
      React15.forwardRef(/* @__PURE__ */ __name(function Dialog22(props, ref) {
        const {
          __scopeDialog,
          children,
          open: openProp,
        ...
        const onOpenToggle = React15.useCallback(
  ...
  "../../node_modules/@tamagui/alert-dialog/dist/cjs/AlertDialog.js"(exports, module2) {
    ...
    var AlertDialogInner = /* @__PURE__ */ __name((props) => {
      ...
      if (process.env.TAMAGUI_TARGET === "native") {
        ...
        let description = "";
        const buttons = [];
        forEachChildDeep(React15.Children.toArray(props.children), (child) => {
          ...
          switch (name) {
            case TRIGGER_NAME2: {
              triggerElement = React15.cloneElement(child, {
                __native: true
              });
              return false;
            }
        ...
        if (native) {
          return React15.cloneElement(triggerElement, {
            __onPress: () => {
              setOpen(true);
            }
          });
    ...
    function forEachChildDeep(children, onChild) {
      for (const child of children) {
        ...
        if (child.props.children) {
          forEachChildDeep(React15.Children.toArray(child.props.children), onChild);
        }
      }
    }
    ...
    function getStringChildren(child) {
      let string = "";
      forEachChildDeep(React15.Children.toArray(child), (child2) => {
...
var require_Image = __commonJS({
  "../../node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    var StyledImage = (0, import_core29.styled)(import_react_native8.Image, {
      name: "Image",
      position: "relative",
      source: { uri: "" },
      zIndex: 1
  ...
  "../../node_modules/@tamagui/helpers-tamagui/dist/cjs/useGetThemedIcon.js"(exports, module2) {
    ...
    var useGetThemedIcon2 = /* @__PURE__ */ __name((props) => {
      ...
      return (el) => {
        if (!el)
          return el;
        if ((0, import_react12.isValidElement)(el)) {
          return (0, import_react12.cloneElement)(el, {
            ...props,
            ...el.props
          });
        }
        return (0, import_react12.createElement)(el, props);
      };
    }, "useGetThemedIcon");
  }
});
  ...
  "../../node_modules/@tamagui/focusable/dist/cjs/focusableInputHOC.js"(exports, module2) {
    ...
    function focusableInputHOC3(Component2) {
      const component = Component2.extractable(
        (0, import_react12.forwardRef)(
          (props, ref) => {
            const isInput = (0, import_core29.isTamaguiComponent)(Component2) && Component2.staticConfig.isInput;
            const inputValue = (0, import_react12.useRef)(props.value || props.defaultValue || "");
            const unregisterFocusable = (0, import_react12.useRef)();
            const inputRef = (0, import_react12.useCallback)(
              (input) => {
                var _a;
                if (!props.id)
                  return;
...
var require_LinearGradient_shared = __commonJS({
  "../../node_modules/@tamagui/linear-gradient/dist/cjs/LinearGradient.shared.js"(exports, module2) {
    ...
    var LinearGradient3 = import_stacks9.YStack.extractable(
      (0, import_core29.themeable)(
        React15.forwardRef((props, ref) => {
    ...
    var LinearGradientFrame = (0, import_core29.styled)(import_stacks9.YStack, {
      name: "LinearGradient",
      overflow: "hidden",
      position: "relative"
    });
    var useThemeColors = /* @__PURE__ */ __name((colors) => {
      ...
      return colors.map((color) => {
        if (color[0] === "$") {
          return (0, import_core29.getVariable)(theme[color] || color);
        }
        return color;
      });
    }, "useThemeColors");
...
var require_ListItem = __commonJS({
  "../../node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var useListItem = /* @__PURE__ */ __name((props, {
      ...
      const subtitleSizeToken = (0, import_get_size2.getSize)(size2, -3);
    ...
    var ListItemComponent = (0, import_react12.forwardRef)((props, ref) => {
...
var React10, import_react6, ReactDOM, arrow2, index;
...
var require_useFloating = __commonJS({
  "../../node_modules/@tamagui/popper/dist/cjs/useFloating.js"(exports, module2) {
    ...
    var FloatingOverrideContext2 = (0, import_react12.createContext)(null);
    var useFloating4 = /* @__PURE__ */ __name((props) => {
      var _a;
      const context = (0, import_react12.useContext)(FloatingOverrideContext2);
...
var require_Popper = __commonJS({
  "../../node_modules/@tamagui/popper/dist/cjs/Popper.js"(exports, module2) {
    ...
    var Popper = /* @__PURE__ */ __name((props) => {
      ...
      const anchorRef = React15.useRef();
      const [arrowEl, setArrow] = React15.useState(null);
      const [arrowSize, setArrowSize] = React15.useState(0);
      const arrowRef = React15.useRef();
    ...
    var PopperContent = PopperContentFrame.extractable(
      React15.forwardRef(
        (props, forwardedRef) => {
          ...
          const contents = React15.useMemo(() => {
    ...
    var PopperArrow = PopperArrowFrame.extractable(
      React15.forwardRef(/* @__PURE__ */ __name(function PopperArrow2(props, forwardedRef) {
        const {
          __scopePopper,
          offset: offset2,
          size: sizeProp,
...
function safePolygon(_temp) {
  ...
  const fn = /* @__PURE__ */ __name((_ref) => {
    ...
    return /* @__PURE__ */ __name(function onMouseMove(event) {
      ...
      if (event.type === "mouseleave" && isElement2(event.relatedTarget) && contains(refs.floating.current, event.relatedTarget)) {
        return;
      }
...
function FloatingFocusManager(_ref) {
  ...
  const [tabbableContentLength, setTabbableContentLength] = React11.useState(null);
  const initialFocusControlled = typeof initialFocus === "number" && initialFocus < 0;
  const startDismissButtonRef = React11.useRef(null);
  const endDismissButtonRef = React11.useRef(null);
  const preventReturnFocusRef = React11.useRef(false);
  const previouslyFocusedElementRef = React11.useRef(null);
  ...
  const getTabbableContent = React11.useCallback(function(container) {
    if (container === void 0) {
      container = refs.floating.current;
    }
    return container ? (0, import_tabbable.tabbable)(container, getTabbableOptions()) : [];
  }, [refs]);
  const getTabbableElements = React11.useCallback((container) => {
  ...
  React11.useEffect(() => {
    ...
    if (floating && isHTMLElement2(reference)) {
      ...
      if (modal) {
        ...
        cleanup = (0, import_aria_hidden2.hideOthers)(orderRef.current.includes("reference") || typeableCombobox ? insideNodes.concat(reference) : insideNodes);
      }
  ...
  function renderDismissButton(location) {
    return visuallyHiddenDismiss && modal ? /* @__PURE__ */ React11.createElement(VisuallyHiddenDismiss, {
      ref: location === "start" ? startDismissButtonRef : endDismissButtonRef,
      onClick: () => onOpenChange(false)
    }, typeof visuallyHiddenDismiss === "string" ? visuallyHiddenDismiss : "Dismiss") : null;
  }
  __name(renderDismissButton, "renderDismissButton");
  return /* @__PURE__ */ React11.createElement(React11.Fragment, null, shouldRenderGuards && /* @__PURE__ */ React11.createElement(FocusGuard, {
  ...
  }), typeableCombobox ? null : renderDismissButton("start"), /* @__PURE__ */ React11.cloneElement(children, tabbableContentLength === 0 || order.includes("floating") ? {
    tabIndex: 0
  } : {}), renderDismissButton("end"), shouldRenderGuards && /* @__PURE__ */ React11.createElement(FocusGuard, {
...
var React11, import_react7, import_react_dom2, import_tabbable, import_aria_hidden2, index2, serverHandoffComplete, count, genId, useReactId, useId3, FloatingNodeContext, FloatingTreeContext, useFloatingParentNodeId, useFloatingTree, useFloatingNodeId, FloatingNode, FloatingTree, useInsertionEffect, useSafeInsertionEffect, useInteractions2, HIDDEN_STYLES, activeElement$1, timeoutId, FocusGuard, getTabbableOptions, PortalContext, useFloatingPortalNode, FloatingPortal, usePortalContext2, identifier, FloatingOverlay, TYPEABLE_SELECTOR, rafId, VisuallyHiddenDismiss, mouseLikePointerTypes, useHover, FloatingDelayGroupContext, useDelayGroupContext, FloatingDelayGroup, useDelayGroup, inner, useInnerOffset, useRole2, useClick, bubbleHandlerKeys, captureHandlerKeys, useDismiss2, useFocus2, isPreventScrollSupported, ARROW_UP, ARROW_DOWN, ARROW_LEFT, ARROW_RIGHT, useListNavigation, useTypeahead;
var init_floating_ui_react_dom_interactions_esm = __esm({
  "../../node_modules/@floating-ui/react-dom-interactions/dist/floating-ui.react-dom-interactions.esm.js"() {
    ...
    useReactId = React11[/* @__PURE__ */ "useId".toString()];
    useId3 = useReactId != null ? useReactId : useFloatingId;
    FloatingNodeContext = /* @__PURE__ */ React11.createContext(null);
    FloatingTreeContext = /* @__PURE__ */ React11.createContext(null);
    useFloatingParentNodeId = /* @__PURE__ */ __name(() => {
      var _React$useContext$id, _React$useContext;
      return (_React$useContext$id = (_React$useContext = React11.useContext(FloatingNodeContext)) == null ? void 0 : _React$useContext.id) != null ? _React$useContext$id : null;
    }, "useFloatingParentNodeId");
    useFloatingTree = /* @__PURE__ */ __name(() => React11.useContext(FloatingTreeContext), "useFloatingTree");
    ...
    FloatingNode = /* @__PURE__ */ __name((_ref) => {
      ...
      return /* @__PURE__ */ React11.createElement(FloatingNodeContext.Provider, {
    ...
    FloatingTree = /* @__PURE__ */ __name((_ref2) => {
      ...
      const nodesRef = React11.useRef([]);
      const addNode = React11.useCallback((node) => {
        nodesRef.current = [...nodesRef.current, node];
      }, []);
      const removeNode = React11.useCallback((node) => {
        nodesRef.current = nodesRef.current.filter((n) => n !== node);
      }, []);
      const events = React11.useState(() => createPubSub())[0];
      return /* @__PURE__ */ React11.createElement(FloatingTreeContext.Provider, {
        value: React11.useMemo(() => ({
          nodesRef,
          addNode,
          removeNode,
    ...
    __name(isMac, "isMac");
    useInsertionEffect = React11[/* @__PURE__ */ "useInsertionEffect".toString()];
    ...
    FocusGuard = /* @__PURE__ */ React11.forwardRef(/* @__PURE__ */ __name(function FocusGuard2(props, ref) {
      ...
      return /* @__PURE__ */ React11.createElement("span", _extends({}, props, {
        ref,
        tabIndex: 0,
        role,
    ...
    PortalContext = /* @__PURE__ */ React11.createContext(null);
    useFloatingPortalNode = /* @__PURE__ */ __name(function(_temp) {
      let {
        id,
        enabled = true
      } = _temp === void 0 ? {} : _temp;
      const [portalEl, setPortalEl] = React11.useState(null);
    ...
    FloatingPortal = /* @__PURE__ */ __name((_ref) => {
      ...
      return /* @__PURE__ */ React11.createElement(PortalContext.Provider, {
        value: React11.useMemo(() => ({
          preserveTabOrder,
          beforeOutsideRef,
          afterOutsideRef,
      ...
      }, shouldRenderGuards && portalNode && /* @__PURE__ */ React11.createElement(FocusGuard, {
      ...
      }), shouldRenderGuards && portalNode && /* @__PURE__ */ React11.createElement("span", {
        "aria-owns": portalNode.id,
        style: HIDDEN_STYLES
      }), root ? /* @__PURE__ */ (0, import_react_dom2.createPortal)(children, root) : portalNode ? /* @__PURE__ */ (0, import_react_dom2.createPortal)(children, portalNode) : null, shouldRenderGuards && portalNode && /* @__PURE__ */ React11.createElement(FocusGuard, {
        ref: afterOutsideRef,
        onFocus: (event) => {
          if (isOutsideEvent(event, portalNode)) {
    ...
    usePortalContext2 = /* @__PURE__ */ __name(() => React11.useContext(PortalContext), "usePortalContext");
    identifier = "data-floating-ui-scroll-lock";
    FloatingOverlay = /* @__PURE__ */ React11.forwardRef(/* @__PURE__ */ __name(function FloatingOverlay2(_ref, ref) {
      let {
        lockScroll = false,
        ...rest
      } = _ref;
      ...
      return /* @__PURE__ */ React11.createElement("div", _extends({
        ref
      }, rest, {
        style: {
          position: "fixed",
    ...
    VisuallyHiddenDismiss = /* @__PURE__ */ React11.forwardRef(/* @__PURE__ */ __name(function VisuallyHiddenDismiss2(props, ref) {
      return /* @__PURE__ */ React11.createElement("button", _extends({}, props, {
        ref,
        tabIndex: -1,
        style: HIDDEN_STYLES
      }));
    ...
    mouseLikePointerTypes = ["mouse", "pen", "", void 0];
    ...
    FloatingDelayGroupContext = /* @__PURE__ */ React11.createContext({
      delay: 1e3,
      initialDelay: 1e3,
      currentId: null,
      setCurrentId: () => {
    ...
    useDelayGroupContext = /* @__PURE__ */ __name(() => React11.useContext(FloatingDelayGroupContext), "useDelayGroupContext");
    ...
    useInnerOffset = /* @__PURE__ */ __name((_ref, _ref2) => {
      ...
      const controlledScrollingRef = React11.useRef(false);
      const prevScrollTopRef = React11.useRef(null);
      const initialOverflowRef = React11.useRef(null);
      React11.useEffect(() => {
    ...
    useDismiss2 = /* @__PURE__ */ __name(function(_ref, _temp) {
      ...
      const outsidePressRef = useLatestRef2(outsidePress);
      ...
      React11.useEffect(() => {
        ...
        function onOutsidePress(event) {
          ...
          const target = getTarget(event);
          if (isElement2(target) && refs.floating.current) {
        ...
        let ancestors = [];
        if (ancestorScroll) {
          if (isElement2(refs.domReference.current)) {
            ancestors = getOverflowAncestors(refs.domReference.current);
          }
          if (isElement2(refs.floating.current)) {
            ancestors = ancestors.concat(getOverflowAncestors(refs.floating.current));
          }
          if (!isElement2(refs.reference.current) && refs.reference.current && // @ts-expect-error is VirtualElement
    ...
    useFocus2 = /* @__PURE__ */ __name(function(_ref, _temp) {
      ...
      React11.useEffect(() => {
        ...
        function onBlur() {
          if (!open && isHTMLElement2(refs.domReference.current) && refs.domReference.current === activeElement(getDocument(refs.domReference.current))) {
    ...
    useListNavigation = /* @__PURE__ */ __name(function(_ref, _temp2) {
      ...
      const focusItemOnOpenRef = React11.useRef(focusItemOnOpen);
      const indexRef = React11.useRef(selectedIndex != null ? selectedIndex : -1);
      const keyRef = React11.useRef(null);
      const blockPointerLeaveRef = React11.useRef(false);
      const previousOnNavigateRef = React11.useRef(onNavigate);
      const previousOpenRef = React11.useRef(open);
      const forceSyncFocus = React11.useRef(false);
      const disabledIndicesRef = useLatestRef2(disabledIndices);
      const latestOpenRef = useLatestRef2(open);
      const [activeId, setActiveId] = React11.useState();
      const focusItem = React11.useCallback((listRef2, indexRef2) => {
        if (virtual) {
        ...
        return {
          ...
          item: {
            onFocus(_ref2) {
              ...
              if (index3 !== -1 && activeIndex !== index3) {
                onNavigate(index3);
              }
            },
            onClick: (_ref3) => {
    ...
    useTypeahead = /* @__PURE__ */ __name(function(_ref, _temp) {
      ...
      const timeoutIdRef = React11.useRef();
      const stringRef = React11.useRef("");
      const prevIndexRef = React11.useRef((_ref2 = selectedIndex != null ? selectedIndex : activeIndex) != null ? _ref2 : -1);
      const matchIndexRef = React11.useRef(null);
      ...
      return React11.useMemo(() => {
        ...
        function onKeyDown(event) {
          ...
          if (isElement2(target) && (activeElement(getDocument(target)) !== event.currentTarget ? target.closest('[role="dialog"],[role="menu"],[role="listbox"],[role="tree"],[role="grid"]') !== event.currentTarget : false)) {
            return;
          }
...
var require_Popover = __commonJS({
  "../../node_modules/@tamagui/popover/dist/cjs/Popover.js"(exports, module2) {
    ...
    var PopoverTrigger = React15.forwardRef((props, forwardedRef) => {
    ...
    var PopoverContent = React15.forwardRef((props, forwardedRef) => {
      const {
        allowPinchZoom,
        trapFocus,
    ...
    var PopoverContentImpl = React15.forwardRef((props, forwardedRef) => {
      const {
        __scopePopover,
        trapFocus,
        onOpenAutoFocus,
      ...
      if (showSheet) {
        const childrenWithoutScrollView = React15.Children.toArray(children).map((child) => {
          if (React15.isValidElement(child)) {
    ...
    var PopoverScrollView = React15.forwardRef((props, ref) => {
    ...
    var Popover = (0, import_core29.withStaticProperties)(
      (props) => {
        ...
        const useFloatingContext = React15.useCallback(
          (props2) => {
...
var require_SelectImpl = __commonJS({
  "../../node_modules/@tamagui/select/dist/cjs/SelectImpl.js"(exports, module2) {
    ...
    var SelectInlineImpl = /* @__PURE__ */ __name((props) => {
      ...
      const touch = (0, import_core29.useIsTouchDevice)();
      const listItemsRef = React15.useRef([]);
      const overflowRef = React15.useRef(null);
      const upArrowRef = React15.useRef(null);
      const downArrowRef = React15.useRef(null);
      const allowSelectRef = React15.useRef(false);
      const allowMouseUpRef = React15.useRef(true);
      const selectTimeoutRef = React15.useRef();
      const state = React15.useRef({
        isMouseOutside: false
      });
      const [controlledScrolling, setControlledScrolling] = React15.useState(false);
      const [fallback, setFallback] = React15.useState(false);
      const [innerOffset, setInnerOffset] = React15.useState(0);
      const [blockSelection, setBlockSelection] = React15.useState(false);
      const floatingStyle = React15.useRef({});
      React15.useEffect(() => {
...
var require_SelectScrollButton = __commonJS({
  "../../node_modules/@tamagui/select/dist/cjs/SelectScrollButton.js"(exports, module2) {
    ...
    var SelectScrollButtonImpl = React15.memo(
      React15.forwardRef(
        (props, forwardedRef) => {
          var _a;
          ...
          const statusRef = React15.useRef("idle");
          const isVisible = context[dir === "down" ? "canScrollDown" : "canScrollUp"];
          const frameRef = React15.useRef();
  ...
  "../../node_modules/@tamagui/select/dist/cjs/Select.js"(exports, module2) {
    ...
    var Select = (0, import_core210.withStaticProperties)(
      (props) => {
        ...
        const forceUpdate = React15.useReducer(() => ({}), {})[1];
        ...
        const selectedIndexRef = React15.useRef(null);
        const activeIndexRef = React15.useRef(null);
        const listContentRef = React15.useRef([]);
        const [selectedIndex, setSelectedIndex] = React15.useState(
  ...
  "../../node_modules/@tamagui/slider/dist/cjs/Slider.js"(exports, module2) {
    ...
    var SliderHorizontal = React15.forwardRef(
      (props, forwardedRef) => {
        ...
        const [state, setState] = React15.useState(() => ({ size: 0, offset: 0 }));
    ...
    var SliderTrackActive = React15.forwardRef(
      (props, forwardedRef) => {
    ...
    var SliderThumb = React15.forwardRef(
      (props, forwardedRef) => {
        ...
        const [size2, setSize] = React15.useState(() => {
    ...
    var Slider = (0, import_core29.withStaticProperties)(
      React15.forwardRef((props, forwardedRef) => {
        const {
          name,
          min: min3 = 0,
          max: max3 = 100,
...
var require_Label = __commonJS({
  "../../node_modules/@tamagui/label/dist/cjs/Label.js"(exports, module2) {
    ...
    var LabelComponent2 = React15.forwardRef(
      (props, forwardedRef) => {
...
var require_Tooltip = __commonJS({
  "../../node_modules/@tamagui/tooltip/dist/cjs/Tooltip.js"(exports, module2) {
    ...
    var TooltipArrow = React15.forwardRef((props, ref) => {
    ...
    var TooltipGroup = /* @__PURE__ */ __name(({ children, delay }) => {
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react_dom_interactions.FloatingDelayGroup, {
        delay: React15.useMemo(() => delay, [JSON.stringify(delay)]),
        children
      });
    }, "TooltipGroup");
    var Tooltip = (0, import_core29.withStaticProperties)(
      (props) => {
        ...
        const useFloatingContext = React15.useCallback(useFloatingFn, [id, delay, open]);
        const onCustomAnchorAdd = React15.useCallback(() => setHasCustomAnchor(true), []);
        const onCustomAnchorRemove = React15.useCallback(() => setHasCustomAnchor(false), []);
        const contentId = (0, import_core29.useId)();
...
var require_cjs42 = __commonJS({
  "../../node_modules/@tamagui/use-debounce/dist/cjs/index.js"(exports, module2) {
    ...
    function useDebounce(fn, wait, options = defaultOpts, mountArgs = []) {
      const dbEffect = (0, import_react12.useRef)(null);
      (0, import_react12.useEffect)(() => {
        return () => {
          var _a;
    ...
    function useDebounceValue(val, amt = 0) {
      const [state, setState] = (0, import_react12.useState)(val);
      (0, import_react12.useEffect)(() => {
        const tm = setTimeout(() => {
          setState((prev) => {
            if (prev === val)
...
var require_constants5 = __commonJS({
  "../../node_modules/@tamagui/constants/dist/cjs/constants.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect3 = isRSC3 ? idFn4 : isServer2 ? import_react12.useEffect : import_react12.useLayoutEffect;
...
function wrapChildrenInText(TextComponent, propsIn) {
  ...
  function concatStringChildren() {
    ...
    const index3 = nextChildren.length - 1;
    const childrenStrings = nextChildren[index3];
    nextChildren[index3] = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TextComponent, {
      ...props,
      ...textProps,
      children: childrenStrings
    }, index3);
...
function useForceUpdate() {
  return isServerSide ? idFn3 : (0, import_react8.useReducer)((x) => x + 1, 0)[1];
}
...
var Anchor = AnchorFrame.extractable(
  (0, import_react9.forwardRef)(({ href, target, ...props }, ref) => {
...
function Grid({ children, columns, itemMinWidth = 200, gap }) {
  ...
  const childrenList = import_react10.default.Children.toArray(children);
...
function createGroup(verticalDefault) {
  return (0, import_react11.forwardRef)((props, ref) => {
    ...
    const childrens = import_react11.Children.toArray(childrenProp);
...
var cloneElementWithPropOrder = /* @__PURE__ */ __name((child, props) => {
  ...
  return import_react11.default.cloneElement({ ...child, props: null }, next);
